...
class SalesforceProcessor:
    ...
    def handle_organizations_report(self, row):
        account_info = {
            ...
            'vnfp__Do_not_Email__c' : False if row['Email Addresses\\Do not email'] != True else True,
        }
...
report_names = ["Veevart Organizations Report test","Veevart Organization Addresses Report test", "Veevart Organization Phones Report test", "Veevart HouseHolds Report test"]
