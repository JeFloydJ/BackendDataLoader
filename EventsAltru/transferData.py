...
class SalesforceProcessor:
    def __init__(self, report_name):
        ...
        with open(ABS_PATH.format('/serverSalesforce/access_token.txt'), 'r') as f:
            self.access_token = f.read().strip()
        self.sf = Salesforce(instance='veevartimplementation.my.salesforce.com', session_id=self.access_token)

        self.organizations_id = self.get_organizations_id() 
        self.households_id = self.get_households_id()
        self.number_of_contact = self.get_number_of_contacts()
    ...
    def get_account_id(self):
        ...
        max_records = self.number_of_contact
        try:
    ...
    def process_organizations(self):
        ...
        with open(ABS_PATH.format(f'data/{self.report_name}.csv'), 'r', encoding='utf-8-sig') as f:
            ...
            for row in reader:
                ...
                # if 'Veevart Organization Phones Report test' == self.report_name: 
        ...
        #mdapi = self.sf.mdapi
        #custom_object = mdapi.CustomObject.read("vnfp__Legacy_Data__c")
        #print(custom_object)
        # elif self.phone_list:
...
report_names = ["Veevart Organizations Report test","Veevart Organization Addresses Report test", "Veevart Organization Phones Report test", "Veevart HouseHolds Report test", "Veevart Contacts Report test", "Veevart Contacts Report Address test", "Veevart Contacts Report Email test", "Veevart Contacts Report Phones test"]
dic_accounts = {}
dic_households_ids = {}
